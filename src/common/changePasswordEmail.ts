export const passwordEmail = `<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8" />
							...
							>
								...
								>
									...
									<div style="margin-bottom: 15px">
										...
										width="150"
											alt="Logo"
											src="https://elisafinance.com/assets/media/auth/password-changed.png"
										/>
									</div>
									<!--end:Media-->
									...
									>
										...
										<p
											...
											"
										>
											Click on the button below to change
											your password.
											<br />
											<small
												>Ignore if you didn't request a
									...
									<!--begin:Action-->
									<a
										href="https://elisafinance.com/change-password/?token={{token}}"
										target="_blank"
										style="
